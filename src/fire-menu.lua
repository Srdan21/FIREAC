...
-- MENU 2
local menu2 = MenuV:CreateMenu(false, "FIRE-AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'FIRE-AC: Admin Menu')
...
-- MENU 3
local menu3 = MenuV:CreateMenu(false, "FIRE-AC: Connected Players", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'FIRE-AC: Connected Players')
...
-- MENU 4
local menu4 = MenuV:CreateMenu(false, "FIRE-AC Server Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'FIRE-AC: Server Tools')
...
-- MENU 5
local menu5 = MenuV:CreateMenu(false, "FIRE-AC Teleport Options", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'FIRE-AC: Teleport Options')
...
-- PRINCIPAL MENU
local menu = MenuV:CreateMenu(false, "Welcome to FIRE-AC Admin Menu", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'FIRE-AC: Main Menu')
